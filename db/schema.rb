...
ActiveRecord::Schema[7.0].define(version: 2023_05_11_175139) do
  ...
  create_table "time_availabilities", force: :cascade do |t|
    ...
    t.index ["users_id"], name: "index_time_availabilities_on_users_id"
  end
  ...
  add_foreign_key "time_availabilities", "users", column: "users_id"
end
